...
//    }
    ...
    public void addFavorite(SQLiteDatabase db, int id, String title, String content, String images, String date, int exciting, int naive, String recent, int answerCount, int authorId, String authorName, String authorAvatar, int isExciting, int isNaive, int isFavorite) {
        StringBuffer values = new StringBuffer();
        values.append("replace into favorite values");
        values.append("(");
        values.append(id);
        values.append(",\'" + title + "\'");
        values.append(",\'" + content + "\'");
...
//    public static void readFavorite(SQLiteDatabase db, List<Favorite> favoriteList) {
...
//            favorite.setContent(cursor.getString(cursor.getColumnIndex("content")));
//            favorite.setImages(cursor.getString(cursor.getColumnIndex("images")));
//            favorite.setDate(cursor.getString(cursor.getColumnIndex("date")));
//            favorite.setExciting(cursor.getInt(cursor.getColumnIndex("exciting")));
//            favorite.setNaive(cursor.getInt(cursor.getColumnIndex("naive")));
//            favorite.setRecent(cursor.getString(cursor.getColumnIndex("recent")));
//            favorite.setAnswerCount(cursor.getInt(cursor.getColumnIndex("answerCount")));
//            favorite.setAuthorId(cursor.getInt(cursor.getColumnIndex("authorId")));
//            favorite.setAuthorName(cursor.getString(cursor.getColumnIndex("authorName")));
//            favorite.setAuthorAvatar(cursor.getString(cursor.getColumnIndex("authorAvatar")));
//            favorite.setExciting(cursor.getInt(cursor.getColumnIndex("isExciting")) == 1 ? true : false);
//            favorite.setNaive(cursor.getInt(cursor.getColumnIndex("isNaive")) == 1 ? true : false);
