        ...
        public void handleMessage(@NonNull Message msg) {
            switch (msg.what) {
                case MainActivity.TYPE_MODIFY_AVATAR:
                    ...
                    URLPostUtils urlPostUtils = new URLPostUtils(context, msg.obj.toString());
                    urlPostUtils.post(URLPostUtils.URL_MODIFY_AVATAR, query, URLPostUtils.TYPE_MODIFY_AVATAR);
                    break;
                case MainActivity.TYPE_ANSWER:
                    QuestionActivity.image = msg.obj.toString();
                    break;
                case MainActivity.TYPE_QUESTION:
                    EnterQuestionActivity.images = msg.obj.toString();
                    break;
            }
        }
    };
